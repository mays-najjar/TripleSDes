...
public class TCPServer {
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            sersock = new ServerSocket(PORT);//step1: connect the socket with port 
        ...
        do {
            handleClient(); // method to handel the client which connect with server
        } while (true);
    ...
    private static void handleClient() throws IOException {
        ...
        try {
            ...
            do {
               ...
               int number = Integer.parseInt(message); // Cast the array of string to int 
               int[] res = new int[8];
               res = SDes_D(k1, k2, k3, number); // call method SDes Decryption to get the Plain text.
    ...
    public static int[] SDes_D(int k11, int k22, int k33, int cipher) {
          // defined attribute
        int k1[] = new int[10];
        int ky1;
        int k2[] = new int[10];
        ...
        int arr[] = new int[8];
        // enter  the key 1,2,3 and receive cipher text 
         ky1 = k11;
        for (int i = 9; i >= 0; i--) {
            k1[i] = ky1 % 10;
            ky1 /= 10;
       ...
       // System.out.println("enter the ciphertext");
        ...
        /*/////////////////////////////////////////////////////////////*/
        // make equation D(k1,E(k2,D(k3,p) triple sdes
        arr4 = dec(arr, k3);
...
// the final result store in arr6 and print it 
        arr6 = dec(arr5, k1);
